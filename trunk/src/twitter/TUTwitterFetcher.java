   ...
   //		int geoNotNull=0;
    ...
    /*    
        ...
        for (int i = 1; i < 5; i++) {
            ...
            try {
            	qrTweets = twitter.search(query);
            } catch (TwitterException ex) {
            	final String mainClassName = TUTwitterFetcher.class.getName();
                Logger.getLogger(mainClassName).log(Level.SEVERE, null, ex);
            }
